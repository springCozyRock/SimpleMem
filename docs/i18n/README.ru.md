...
[🚀 Быстрый старт](#-быстрый-старт) • [🌟 Обзор](#-обзор) • [📦 Установка](#-установка) • [🔌 MCP Server](#-mcp-server-текстовая-память) • [📝 Цитирование](#-цитирование)
...
Каждая составляющая имеет свой запускатель бенчмарка в собственной директории. Сначала установите дополнительные зависимости для бенчмарков: `pip install -e ".[benchmark]"`.
...
Используйте точные конфигурации в `config.py`:
- **🚀 Высокая производительность**: GPT-4.1-mini, Qwen3-Plus
- **⚙️ Эффективные**: Qwen2.5-1.5B, Qwen2.5-3B
- **🔍 Эмбеддинги**: Qwen3-Embedding-0.6B (1024-d)
