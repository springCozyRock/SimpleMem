...
[🚀 البداية السريعة](#-البداية-السريعة) • [🌟 نظرة عامة](#-نظرة-عامة) • [📦 التثبيت](#-التثبيت) • [🔌 خادم MCP](#-خادم-mcp-ذاكرة-نصية) • [📝 الاستشهاد](#-الاستشهاد)
...
لكل ركيزة منشغلها الخاص بالمعايير في مجلدها الخاص. ثبّت إضافات المعيار أولاً: `pip install -e ".[benchmark]"`.
...
استخدم الإعدادات الدقيقة في `config.py`:
- **🚀 ذو قدرات عالية**: GPT-4.1-mini، Qwen3-Plus
- **⚙️ فعّال**: Qwen2.5-1.5B، Qwen2.5-3B
- **🔍 تضمين**: Qwen3-Embedding-0.6B (1024-d)
